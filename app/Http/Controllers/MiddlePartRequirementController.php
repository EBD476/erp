...
class MiddlePartRequirementController extends Controller
{
    ...
    public function fill(Request $request)
    {
        ...
        foreach ($middle_part_requirement as $middle_part_requirements) {
            $key++;
            $data .= '["' . $key . '",' . '"' . $middle_part_requirements->hmp_name . '",' . '"' . $middle_part_requirements->hmpr_middle_part_count . '",' . '"' . $middle_part_requirements->hmpr_comment . '",' . '"' . $middle_part_requirements->hmpr_middle_part_id . '",' . '"' . $middle_part_requirements->id . '"],';
        }
