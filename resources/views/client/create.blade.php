            ...
            <div class="row">
                <div class="card-header card-header-primary">
                    ...
                    <form id="form_details_contact" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn badge-primary" style="vert-align: top">{{__('Send')}}</button>
                        </div>
                        </div>
                    </form>
                <div class="col-md-12">
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h6 class="card-subtitle">{{__('Address')}}</h6>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="form_tab_panel_2" class="tab-content setting-tab"
                                      enctype="multipart/form-data">
                                    @csrf
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#form_tab_panel_2").submit(function (event) {
                var data = $("#form_tab_panel_2").serialize();
                event.preventDefault();
                $.blockUI();
