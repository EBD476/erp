                                    ...
                                    <div class="col-md-6 pr-md-1">
                                        <div class="form-group">
                                            ...
                                            <input name="hba_bank_id" type="text" class="form-control" required=""
                                                   aria-invalid="false" value="{{$bank_account->hba_bank_id}}" id="hba_bank_id"
                                    ...
                                    <div class="col-md-6 pr-md-1">
                                        <div class="form-group">
                                            ...
                                            <input name="hba_debt" type="text" class="form-control" required=""
                                                   aria-invalid="false" value="{{$bank_account->hba_debt}}" id="hba_debt"
                                    ...
                                    <div class="col-md-6 pr-md-1">
                                        <div class="form-group">
                                            ...
                                            <input name="hba_crediting" type="text" class="form-control" required=""
                                                   aria-invalid="false" value="{{$bank_account->hba_crediting}}" id="hba_crediting"
                                    ...
                                    <div class="col-md-6 pr-md-1">
                                        <div class="form-group">
                                            ...
                                            <input name="hba_deduction_date" type="text" class="form-control" required=""
                                                   aria-invalid="false" value="{{$bank_account->hba_deduction_date}}" id="hba_deduction_date">
                                        </div>
                                    </div>
                                </div> <div class="row">
                                    <div class="col-md-6 pr-md-1">
                                        <div class="form-group">
                                            ...
                                            <input name="hba_deposit_date" type="text" class="form-control" required=""
                                                   aria-invalid="false" value="{{$bank_account->hba_deposit_date}}" id="hba_deposit_date">
                                        </div>
                                    </div>
                                </div>
