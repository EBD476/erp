                            ...
                            <form id="form2">
                                ...
                                {{--<div class="row">--}}
                                    {{--<div class="col-md-12">--}}
                                        {{--<div class="form-group">--}}
                                            {{--<label>{{__('Product Price')}}</label>--}}
                                            {{--<input name="hp_product_price" id="product_price" type="text"--}}
                                                   {{--class="form-control" required=""--}}
                                                   {{--aria-invalid="false">--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#table').on('click', '.edit', function (event) {
                ...
                $('#hp_description').val(data[8]);
                $('#product_image').val(data[9]);
                $('#hp_image').attr('src','img/products/'+ data[9]);
            })
            // end
