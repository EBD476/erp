...
@section('title',__('Products Color'))
...
@section('content')
    ...
    <div class="content persian">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{route('product-color.create')}}" class="btn btn-primary float-left mb-lg-2">
                        <i class="tim-icons icon-simple-add"></i> &nbsp;
                        {{__('New Product Color')}}
                    </a>
                </div>
                <div class="card">
                    <div class="card-body">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                                ...
                                                                <a class="dropdown-item"
                                                                   href="{{route('product-color.edit',$colors->id)}}"
                                                                >{{__('Edit')}}</a>
                                                                <form id="-form-delete{{$colors->id}}"
                                                                      style="display: none;" method="POST"
                                                                      action="{{route('product-color.destroy',$colors->id)}}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                </form>
                                                                <a class="dropdown-item"
                                                                   onclick="if(confirm('آیا از حذف این پروژه اطمینان دارید؟')){
                                                                           ...
                                                                           document.getElementById('-form-delete{{$colors->id}}').submit();
                                                                           }else {
            ...
            {{--$('#table').on('click', 'button', function (event) {--}}
                ...
                {{--})--}}
                    {{--.then((willDelete) => {--}}
                        {{--if (willDelete) {--}}
                            {{--$.ajax({--}}
                                {{--url: '/product-color-destroy/' + data[0],--}}
                                {{--type: 'delete',--}}
                                {{--data: data,--}}
                                {{--dataType: 'json',--}}
                                {{--async: false,--}}
