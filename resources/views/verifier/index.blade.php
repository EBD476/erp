...
@section('content')
    ...
    <div class="content persian">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{route('verifier.create')}}" class="btn btn-primary float-left mb-lg-2"><i
                                class="tim-icons icon-simple-add"></i>{{__('Add New Verifier')}}</a>
                </div>
                <div class="col-md-9">
                    <div class="card">
                                ...
                                <table id="table" class="table" cellspacing="0" width="100%">
                                    ...
                                    @foreach($verifier as $key => $verify)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('verifier.edit',$verify->id)}}"
                                                   class="btn btn-link btn-warning btn-icon btn-sm btn-neutral  edit">
                                                    <i class="tim-icons icon-pencil"></i></a>
                                                <form id="-form-delete{{$verify->id}}" style="display: none;"
                                                      method="POST" action="{{route('verifier.destroy',$verify->id)}}">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
