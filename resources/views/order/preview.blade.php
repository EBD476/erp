                            ...
                            <div class="row">
                                <div class="col-md-12">
                                                ...
                                                <table class="table table-condensed">
                                                    ...
                                                    <tr>
                                                        <td class="text-left"><h4
                                                                    style="margin-top:30px;">{{__('Date:')}} {{$create_due_date}}</h4>
                                            ...
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                    <table class="table table-condensed">
                                                        ...
                                                        @else
                                                            @foreach($product as $key => $products)
                                                                @foreach($data->name as  $data_name)
                                    ...
                                    <form action="{{route('order.edit_pre',$order->id)}}" method="post">
                                        ...
                                        <button id="edit_pre" type="submit" style="display: flex"
                                                class="btn btn-outline-light">{{__('Back')}}</button>
                                    </form>
                                </div>
                                <button type="submit"
                                        id="btn-1" class="btn btn-outline-light" style="margin-right: 20px">{{__('Verify')}}</button>
                            </div>
                        </div>
                    </div>
                </div>
