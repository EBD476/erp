            ...
            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" required=""
                                                       aria-invalid="false" name="hp_project_name" value="{{$project->hp_project_name}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" required="" aria-invalid="false"
                                                       name="hp_employer_name" {{$project->hp_employer_name}}>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                              ...
                                              <input class="form-control" type="text" name="ho_client" value="{{$project->ho_client}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" required=""
                                                       aria-invalid="false"
                                                       name="hp_connector" value="{{$project->hp_connector}}">
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" required=""
                                                       aria-invalid="false"
                                                       name="hp_phone_number" value="{{$project->hp_phone_number}}">
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" required=""
                                                       aria-invalid="false"
                                                       name="hp_project_area" value="{{$project->hp_project_area}}">
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" required=""
                                                       aria-invalid="false"
                                                       name="hp_number_of_units" value="{{$project->hp_number_of_units}}">
                                            </div>
                ...
                $parent.invoice_items_without_tasks().length > 1" class="fa fa-sort"></i>
                                                ...
                                                <td style="display:table-cell">
                                                    <input  style="text-align: right" class="form-control" value="{{$item->name}}" name="name[]" >
                                                </td>
                                                <td style="display:table-cell">
                                                <textarea
                                                ...
                                                <td style="display:table-cell">
                                                    <input disabled type="text" id="unit" class="form-control"
                                                           name="hp_product_price[]" value="{{$item->hp_product_price}}">
                                                </td>
                                                <td style="display:table-cell">
                                                    <input
                                                            style="text-align: right" class="form-control invoice-item qty"
                                                            name="invoice_items_qty[]" value="{{$item->invoice_items_qty}}">
                                                </td>
                                                <td style="display:none">
                                                    <input data-bind="value: discount, valueUpdate: 'afterkeydown', attr: {name: 'invoice_items[' + $index() + '][discount]'}"
                                                           ...
                                                           name="invoice_items[0][discount]" value="{{$item->invoice_items}}">
                                                </td>
                                        </tr>
                                        @endforeach
                                        </tbody>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-lg-6 col-sm-6">
                                                                <div class="input-group"><input class="form-control"
                                                                                                ...
                                                                                                id="discount"
                                                                                                type="number"
                                                                                                name="hpo_discount" value="{{$items_all->hpo_discount}}">
                                                                    {{--<select--}}
                                                                    {{--class="form-control"--}}
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-lg-6 col-sm-6">
                                                                <input class="form-control"
                                                                       id="test-date-id"
                                                                       type="text"
                                                                       name="hop_due_date" value="{{$items_all->hop_due_date}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-lg-6 col-sm-6">
                                                                    <input disabled class="form-control"
                                                                           type="text"
                                                                           name="total"
                                                                           id="total" value="{{$items_all->total}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-lg-6 col-sm-6">
                                                                    <input disabled class="form-control"
                                                                           type="text"
                                                                           name="total_discount"
                                                                           id="total_discount" value="{{$items_all->total_discount}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-lg-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="hpo_status" class="form-control">
                                                                    <option>{{$items_all->hpo_status}}</option>
