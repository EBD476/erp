                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="table-all" class="table" cellspacing="0" width="100%">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#table-all').on('click', 'button', function (event) {

                var data = table_all.row($(this).parents('tr')).data();
                $.ajaxSetup({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    }
            ...
            var table_all = $('#table-all').on('draw.dt', function (e, settings, json, xhr) {
                }).DataTable({
