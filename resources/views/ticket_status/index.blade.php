...
@section('content')
    ...
    <div class="content persian">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{route('ticket.create')}}" class="btn btn-primary float-left mb-lg-2">
                        <i class="tim-icons icon-simple-add"></i> &nbsp;
                        {{__('New Ticket Status')}}
                    </a>
                </div>
                <div class="card">
                    <div class="card-body">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                                ...
                                                                <a class="dropdown-item"
                                                                   onclick="if(confirm('آیا از حذف این پروژه اطمینان دارید؟')){
                                                                           ...
                                                                           document.getElementById('-form-delete{{$ticket->id}}').submit();
                                                                           }else {
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive table-hover">
                                            <table id="table" class="table" cellspacing="0" width="100%">
                                                ...
                                                @foreach($help_desks_user as $key => $ticket)
                                                    <tr>
                                                        <td>
                                                            {{$ticket ->id}}
                                                        </td>
