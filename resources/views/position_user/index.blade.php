...
@section('title',__('Positions User'))
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title text-right font-weight-400">{{__('Position List')}}</h4>
                ...
                <div class="col-md-4">
                    <div class="card card-user">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title ">{{__('New Position')}}</h4>
                                <p class="card-category"></p>
                            </div>
                            <div class="card-body">
                                <form id="form1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>{{__('Name')}}</label>
                                                <input class="form-control" name="hpu_name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>{{__('Code')}}</label>
                                                <input name="hpu_code" type="text" class="form-control" required=""
                                                       aria-invalid="false">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card card-user" id="card-form2">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title ">{{__('Edit Position')}}</h4>
                                <p class="card-category"></p>
                            </div>
                            <div class="card-body">
                                <form id="form2">
                                    <div class="row">
                                        <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>{{__('Name')}}</label>
                                                    <input id="hpu_name" class="form-control"
                                                           name="hpu_name">
                                                    <input id="position-id" hidden>
                                                </div>
                                            </div>
                                        </div>
                                        <div class=" row">
                                            <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>{{__('Code')}}</label>
                                                        <input name="hpu_code" type="text" class="form-control"
                                                               required=""
                                                               aria-invalid="false" id="hpu_code">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-footer">
