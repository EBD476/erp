...
@section('content')
    ...
    <div class="content persian">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{route('middle-part.create')}}" class="btn btn-primary float-left mb-lg-2">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive table-hover">
                                        <table id="table" class="table" cellspacing="0" width="100%">
                                            ...
                                            @foreach($middle_part as $key => $part)
                                                <tr>
                                                    <td>
                                                        {{$part ->id}}
                                                    </td>
                                                    ...
                                                    <td>
                                                        {{$part ->hmp_serial_number}}
                                                    </td>
                                                    <td>
                                                        {{$part ->hmp_middle_part_model}}
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
                                                            <button type="button"
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                                ...
                                                                <a class="dropdown-item"
                                                                   href="{{route('middle-part.edit',$part->id)}}"
                                                                >{{__('Edit')}}</a>
                                                                <form id="-form-delete{{$part->id}}"
                                                                      style="display: none;" method="POST"
                                                                      action="{{route('middle-part.destroy',$part->id)}}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                </form>
                                                                <a class="dropdown-item"
