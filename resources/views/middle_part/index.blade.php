    ...
    <script>
        $(document).ready(function () {
            ...
            $('#table').on('click', 'button', function (event) {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                url: '/middle-part-destroy/' + data[0],
                                type: 'delete',
                                data: data,
                                dataType: 'json',
                                async: false,
            ...
            $('#table').on('click', '.edit', function (event) {
                ...
                $('#hmp_description').val(data[3]);
                $('#hmp_middle_part_property').val(data[7]);
                // $('#hmp_middle_part_property').text(data[4]);
                $('#hmp_middle_part_color').val(data[8]);
                $('#hmp_provider').val(data[9]);
                $('#hmp_description').val(data[10]);
                // $('#part_image').val(data[11]);
                $('#hp_image').attr('src', 'img/middle_parts/' + data[11]);
