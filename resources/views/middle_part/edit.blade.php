                                    ...
                                    <div class="col-md-6 pr-md-1">
                                        <div class="form-group">
                                            ...
                                            <input name="hmp_name" type="text" class="form-control" required=""
                                                   aria-invalid="false" value="{{$part->hmp_name}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 pr-md-1">
                                        <div class="form-group">
                                            <label>{{__('Code')}}</label>
                                            <input name="hp_serial_number" type="text" class="form-control" required=""
                                                   aria-invalid="false" value="{{$part->hmp_serial_number}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 pr-md-1">
                                        <div class="form-group">
                                            ...
                                            <input name="hmp_middle_part_model" type="text" class="form-control"
                                                   required=""
                                                   aria-invalid="false" value="{{$part->hmp_middle_part_model}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 pr-md-1">
                                        <div class="form-group">
                                            ...
                                            <textarea name="hmp_description" type="number" class="form-control"
                                                      aria-invalid="false">{{$part->hmp_description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                {{--<div class="row">--}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="dz-preview dz-processing dz-image-preview dz-complete">
                                            <div class="dz-image" id="img-remove" style="margin-right: 20px">
                                                <img src={{asset('img/middle_parts/'.$part->hmp_image)}}>
                                            </div>
                                        </div>
                                    </div>
                                </form>
