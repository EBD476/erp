                        ...
                        <div class="md-form mb-5">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="bmd-label-floating"
                                           style="float: right">{{__('Product Name')}}</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="bmd-label-floating"
                                               style="float: right">{{__('Repository Name')}}</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="bmd-label-floating" style="float: right">{{__('Provider')}}</label>
                                    <div class="form-group">
                ...
                <form id="form3">
                    <div class="modal-body mx-3">
                        <div class="md-form mb-5">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="bmd-label-floating" style="float: right">{{__('Part Name')}}</label>
                                    <div class="form-group">
