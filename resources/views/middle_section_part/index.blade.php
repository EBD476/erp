                                            ...
                                            @foreach($product_part as $product_parts)
                                                <tr>
                                                    ...
                                                    @foreach($middle_part as $middle_parts)
                                                        @if($middle_parts->id == $product_parts->hpp_middle_part_id)
                                                        <td>
                                                    ...
                                                    @foreach($parts as $part)
                                                        @if($part->id == $product_parts->hpp_part_id)
                                                            <td>
                                                                {{$part->hp_name}}
                                                            </td>
                                                        @endif
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                                ...
                                                                <a class="dropdown-item"
                                                                   href="{{route('middle-section-part.edit',$product_parts->id)}}"
                                                                >{{__('Edit')}}</a>
                                                                <form id="-form-delete{{$product_parts->id}}"
                                                                      style="display: none;" method="POST"
                                                                      action="{{route('middle-section-part.destroy',$product_parts->id)}}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                </form>
                                                                <a class="dropdown-item"
                                                                   onclick="if(confirm('آیا از حذف این قطعه اطمینان دارید؟')){
                                                                           ...
                                                                           document.getElementById('-form-delete{{$product_parts->id}}').submit();
                                                                           }else {
