...
@section('content')
    ...
    <div class="content persian">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{route('support_status.create')}}" class="btn btn-primary float-left mb-lg-2">
                        <i class="tim-icons icon-simple-add"></i> &nbsp;
                        {{__('New Support Status')}}
                    </a>
                </div>
                <div class="card">
                    <div class="card-body">
                        <div class="col-md-9">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title text-right font-weight-400">{{__('Support Status List')}}</h4>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                                ...
                                                                <a class="dropdown-item"
                                                                   href="{{route('support_status.edit',$statuses->id)}}"
                                                                >{{__('Edit')}}</a>
                                                                <form id="-form-delete{{$statuses->id}}"
                                                                      style="display: none;" method="POST"
                                                                      action="{{route('support_status.destroy',$statuses->id)}}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                </form>
                                                                <a class="dropdown-item"
                                                                   onclick="if(confirm('آیا از حذف این پروژه اطمینان دارید؟')){
                                                                           ...
                                                                           document.getElementById('-form-delete{{$statuses->id}}').submit();
                                                                           }else {
