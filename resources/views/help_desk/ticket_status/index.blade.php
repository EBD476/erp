        ...
        <div class="container-fluid">
            <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title text-right font-weight-400">{{__('Ticket Status List')}}</h4>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title ">{{__('Edit Ticket Status')}}</h4>
                                    <p class="card-category"></p>
                                </div>
                                <div class="card-body">
                                    <form id="form2">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>{{__('Name')}}</label>
                                                    <input id="ts_name" name="ts_name" type="text" class="form-control" required=""
                                                           aria-invalid="false">
                                                    <input id="ticket_s_id" hidden>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#form2").submit(function (event) {
                ...
                var ticket_s_id = $('#ticket_s_id').val();
                event.preventDefault();
                $('#form2').block({
                    message: '{{__('please wait...')}}', css: {
                        border: 'none',
