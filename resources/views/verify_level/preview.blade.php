                        ...
                        <table class="table table-condensed">
                            ...
                            <table>
                                <tr>
                                    <td class="thick-line"></td>
                                    <td class="thick-line"></td>
                                    <td class="thick-line text-left">{{$data_dis->hpo_discount}}</td>
                                ...
                                <tr>
                                    <td class="no-line"></td>
                                    <td class="no-line"></td>
                                    <td class="no-line text-left">{{$data_dis->hpo_total_discount}}</td>
                                ...
                                <tr>
                                    <td class="no-line"></td>
                                    <td class="no-line"></td>
                                    <td class="no-line text-left">{{$data_dis->hpo_total}}</td>
